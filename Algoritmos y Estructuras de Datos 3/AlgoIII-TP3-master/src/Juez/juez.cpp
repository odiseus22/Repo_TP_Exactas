...
void realizarJugada(int jugador[], tableroconalturas &T1,  tableroconalturas &T2, int c){
    int posicionficha = 0;
...
int juez(int M,int N,int c, int p, int* jugador1, int* jugador2){
    ...
    //Cantidad total de fichas jugadas
    int cant_jugadas = 0;

    while(cant_jugadas < 2*p && cant_jugadas < M*N){
