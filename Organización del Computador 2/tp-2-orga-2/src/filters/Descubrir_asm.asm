...
movdqa xmm15, [maskSiete]
movdqa xmm14, [maskSeis]
movdqa xmm13, [maskCinco]
movdqa xmm12, [maskCuatro]
movdqa xmm11, [maskTres]
movdqa xmm10, [maskDos]
movdqa xmm9, [testGreyAndMask]
movdqa xmm8, [test2GreyMask]
movdqa xmm7, [andMask]
movdqa xmm6, [invertirPixeles]
...
pshufb xmm1, xmm6		; xmm1 = |a0,r0,g0,b0|a1,r1,g1,b1|a2,r2,g2,b2|a3,r3,g3,b3| 4 dwords
...
movdqa xmm4, xmm1
psrld xmm4, 15
pand xmm4, xmm10 	;bit 2, red1
por xmm2, xmm4

movdqa xmm4, xmm1
psrld xmm4, 6
pand xmm4, xmm11 	;bit 3, green1
por xmm2, xmm4

movdqa xmm4, xmm1
pslld xmm4, 3
pand xmm4, xmm12 ;bit 4, blue1
por xmm2, xmm4

movdqa xmm4, xmm1
psrld xmm4, 11
pand xmm4, xmm13 	;bit 5, red0
por xmm2, xmm4

movdqa xmm4, xmm1
psrld xmm4, 2
pand xmm4, xmm14 	;bit 6, green0
por xmm2, xmm4

movdqa xmm4, xmm1
pslld xmm4, 7
pand xmm4, xmm15 	;bit 7, blue0
por xmm2, xmm4
